...
export default function AmbientSoundSelector() {
  ...
  const soundOptions = [
    ...
    },
    {
      id: "ocean",
      name: "Vagues océan",
      file: "/assets/ambient/ocean.mp3",
      type: "audio/mpeg",
    },
    {
      id: "forest",
      name: "Forêt",
      file: "/assets/ambient/forest.mp3",
      type: "audio/mpeg",
    },
    {
      id: "wind",
      name: "Vent léger",
      file: "/assets/ambient/wind.mp3",
      type: "audio/mpeg",
    },
    {
      id: "fireplace",
      name: "Feu de cheminée",
      file: "/assets/ambient/fireplace.mp3",
      type: "audio/mpeg",
    },
    {
      id: "tibetan",
      name: "Bols tibétains",
      file: "/assets/ambient/tibetan.mp3",
      type: "audio/mpeg",
    },
  ...
  const togglePlayPause = async () => {
    if (!audioRef.current || !selectedOption || selectedSound === "silence")
      return;
      ...
      {selectedSound !== "silence" && (
        <>
          <div style={{ marginBottom: "15px" }}>
            ...
            {loadingState === "loaded" && (
              <span style={{ color: "green" }}>✓ Fichier chargé</span>
            )}
            {loadingState === "error" && selectedOption && (
              <span style={{ color: "red" }}>
                ❌ Erreur: {selectedOption.file} introuvable
              </span>
            )}
          </div>
